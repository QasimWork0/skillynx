...
export const [BackgroundContext, BackgroundContextProvider] = CreateContext<1|2|3|4>(3)
export const [AlertContext, AlertContextProvider] = CreateContext<AlertInterface|undefined>(undefined)
export const [TextSizeContext, TextSizeContextProvider] = CreateContext<0|1|2>(1)
